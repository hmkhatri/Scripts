...
class TWODimensional_spec(object):
    ...
    def __init__(self,phi,d1,d2,detrend=True,han_win=True):

        self.phi = phi  # two dimensional real field
        self.d1 = d1  # grid interval in dimension 0
        self.d2 = d2  # grid interval in dimnetion 1
